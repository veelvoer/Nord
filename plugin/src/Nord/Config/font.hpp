...
class FontBuilders : public QObject {
    ...
    Q_PROPERTY(nord::config::FontBuilder large READ large NOTIFY buildersChanged FINAL)
    Q_PROPERTY(nord::config::FontBuilder medium READ medium NOTIFY buildersChanged FINAL)
    Q_PROPERTY(nord::config::FontBuilder small READ small NOTIFY buildersChanged FINAL)
...
class IconFontBuilders : public FontBuilders {
    ...
    Q_PROPERTY(nord::config::FontBuilder extraLarge READ extraLarge NOTIFY buildersChanged FINAL)
...
class FontStyle : public FontStyleBase {
    ...
    Q_PROPERTY(nord::config::FontBuilders* builders READ builders CONSTANT FINAL)
...
class IconFontStyle : public FontStyleBase {
    ...
    Q_PROPERTY(nord::config::IconFontBuilders* builders READ builders CONSTANT FINAL)
...
class FontTokens : public QObject {
    ...
    Q_PROPERTY(nord::config::FontStyle* headline READ headline CONSTANT FINAL)
    Q_PROPERTY(nord::config::FontStyle* title READ title CONSTANT FINAL)
    Q_PROPERTY(nord::config::FontStyle* body READ body CONSTANT FINAL)
    Q_PROPERTY(nord::config::FontStyle* label READ label CONSTANT FINAL)
    Q_PROPERTY(nord::config::FontStyle* mono READ mono CONSTANT FINAL)
    Q_PROPERTY(nord::config::IconFontStyle* icon READ icon CONSTANT FINAL)
    Q_PROPERTY(nord::config::FontBuilder clock READ clock NOTIFY clockChanged FINAL)
