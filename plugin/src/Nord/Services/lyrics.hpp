...
class Lyrics : public QObject {
    ...
    Q_PROPERTY(nord::services::LyricsBackend::Backend backend READ backend NOTIFY backendChanged)
    Q_PROPERTY(nord::services::LyricsBackend::Backend preferredBackend READ preferredBackend WRITE
            setPreferredBackend NOTIFY preferredBackendChanged)
    Q_PROPERTY(
        QList<nord::services::LyricCandidate> lyricCandidates READ lyricCandidates NOTIFY lyricCandidatesChanged)
    Q_PROPERTY(nord::services::LyricCandidate selectedCandidate READ selectedCandidate WRITE setSelectedCandidate
