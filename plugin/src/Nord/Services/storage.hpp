...
class Storage : public TickingService {
    ...
    Q_PROPERTY(QQmlListProperty<nord::services::DiskInfo> disks READ disksProp NOTIFY disksChanged)
    Q_PROPERTY(nord::services::DiskInfo* manualPrimaryDisk READ manualPrimaryDisk WRITE setManualPrimaryDisk NOTIFY
            manualPrimaryDiskChanged)
    Q_PROPERTY(nord::services::DiskInfo* primaryDisk READ primaryDisk NOTIFY primaryDiskChanged)
